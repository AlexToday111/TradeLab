...
public class DatasetController {
    ...
    public List<DatasetQualityReportResponse> getDatasetQuality(
        ...
        return datasetService.getDatasetQualityReports(id);
    }

    @GetMapping("/snapshots/{snapshotId}")
    public DatasetSnapshotResponse getDatasetSnapshot(
            @Parameter(description = "Идентификатор snapshot", example = "42")
